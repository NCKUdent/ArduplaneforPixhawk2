...
static int32_t custom_nav_roll_cd;

// The instantaneous desired pitch angle.  Hundredths of a degree
static int32_t nav_pitch_cd;
static int32_t custom_nav_pitch_cd;

// The current centi degree
static int32_t current_roll;
static int32_t current_pitch;
static int32_t current_rudder;
static int32_t current_pitch_stab;
////////////////////////////////////////////////////////////////////////////////
// Waypoint distances
////////////////////////////////////////////////////////////////////////////////
...
static void update_flight_mode(void)
{
    ...
    case STABILIZE:
        nav_roll_cd        = 0;
        nav_pitch_cd       = 0;
		//current_roll = channel_roll->pwm_to_angle();
		//current_pitch = channel_pitch->pwm_to_angle();
		//current_rudder = channel_rudder->pwm_to_angle();
	...
	case LONGITUDINAL:
        ...
        break;
	case CUSTOM_STABILIZE:
	    custom_nav_roll_cd = 0;
		custom_nav_pitch_cd = 0;
